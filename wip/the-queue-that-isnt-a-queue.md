...
|---|---|---|---|---|
| **Queue model** | Random + FIFO | Configurable | FIFO (random at activation) | Pure FIFO |
| **Pre-queue** | Yes, countdown | Yes, optional shuffle | Yes, random at drop | No |
| **Position shown** | Estimated | Estimated | **Exact** | Exact |
| **Bot protection** | PoW, CAPTCHA, fingerprint, behavioral | Rate limiting, Cloudflare bot mgmt | IP intel, fingerprint, anomaly detection | Basic rate limiting |
| **Open source** | No (connectors only) | No | No | Cloudflare/Akamai workers OSS |
| **Pricing** | Enterprise (not public) | Included in Business/Enterprise plans | Free tier available | Free tier available |
