...
*This is the third article in an unplanned series. The [first](/articles/claude-code-retrospective) was about discovering that Claude knew the map but not the compass. This one is about building tools that keep the compass accurate.*
